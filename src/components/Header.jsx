    ...
    <header>
      <div className="mt-20 text-center">
        ...
        <div className="relative">
          <div className="absolute ml-2 flex h-full w-1/5 flex-col justify-center">
            <a href="https://github.com/eduhorta" target="_blank">
              <svg
                className="my-auto"
            ...
            <a
              href="https://www.linkedin.com/in/eduardo-horta-9a8453a5/"
              target="_blank"
            >
              <svg
                className="mt-2"
